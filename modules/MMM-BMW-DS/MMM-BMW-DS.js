...
Module.register("MMM-BMW-DS", {
    ...
    getDom: function() {
        ...
        daily.innerHTML = this.config.tempUnits != "C" ? /* ? shorthand if statement */
            ...
            "&#40;Today&#41; &nbsp" + moment.unix(forecast.daily.data[0].time).local().format('ddd') + " &nbsp" + "<img class = image src=./modules/MMM-BMW-DS/icons/" + forecast.daily.data[0].icon + ".png>" + " &nbsp" + Math.round(to_celcius(forecast.daily.data[0].temperatureHigh)) +" &nbsp &nbsp  &nbsp &nbsp &nbsp" +
            moment.unix(forecast.daily.data[1].time).local().format('ddd') + " &nbsp" + "<img class = image src=./modules/MMM-BMW-DS/icons/" + forecast.daily.data[1].icon + ".png>" + " &nbsp" + Math.round(to_celcius(forecast.daily.data[1].temperatureHigh)) + " &nbsp &nbsp  &nbsp &nbsp &nbsp" +
            moment.unix(forecast.daily.data[2].time).local().format('ddd') + " &nbsp" + "<img class = image src=./modules/MMM-BMW-DS/icons/" + forecast.daily.data[2].icon + ".png>" + " &nbsp" + Math.round(to_celcius(forecast.daily.data[2].temperatureHigh)) + " &nbsp &nbsp  &nbsp &nbsp &nbsp" +
            moment.unix(forecast.daily.data[3].time).local().format('ddd') + " &nbsp" + "<img class = image src=./modules/MMM-BMW-DS/icons/" + forecast.daily.data[3].icon + ".png>" + " &nbsp" + Math.round(to_celcius(forecast.daily.data[3].temperatureHigh)) + " &nbsp &nbsp  &nbsp &nbsp &nbsp" +
            moment.unix(forecast.daily.data[4].time).local().format('ddd') + " &nbsp" + "<img class = image src=./modules/MMM-BMW-DS/icons/" + forecast.daily.data[4].icon + ".png>" + " &nbsp" + Math.round(to_celcius(forecast.daily.data[4].temperatureHigh)) + " &nbsp &nbsp  &nbsp &nbsp &nbsp" +
            moment.unix(forecast.daily.data[5].time).local().format('ddd') + " &nbsp" + "<img class = image src=./modules/MMM-BMW-DS/icons/" + forecast.daily.data[5].icon + ".png>" + " &nbsp" + Math.round(to_celcius(forecast.daily.data[5].temperatureHigh)) + " &nbsp &nbsp  &nbsp &nbsp &nbsp" +
            moment.unix(forecast.daily.data[6].time).local().format('ddd') + " &nbsp" + "<img class = image src=./modules/MMM-BMW-DS/icons/" + forecast.daily.data[6].icon + ".png>" + " &nbsp" + Math.round(to_celcius(forecast.daily.data[6].temperatureHigh)) + " &nbsp &nbsp  &nbsp &nbsp &nbsp"
